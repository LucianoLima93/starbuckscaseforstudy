...
// Seus imports de fontes continuam iguais:
...
const GlobalStyle = () => (
  <Global
    // O Emotion injeta o 'theme' do seu ThemeProvider diretamente aqui
    styles={(theme) => css`
      html {
        font-size: 62.5%;
      ...
      *, :after, :before {
      ...
      body {
        margin: 0;
        height: 100%;
        /* Acessando o tema diretamente, sem precisar de (props) => */
        background-color: ${theme.color.neutral.high.pure};
        ...
        letter-spacing: .1px;
        font-weight: 400;
        color: ${theme.color.neutral.low.dark};
